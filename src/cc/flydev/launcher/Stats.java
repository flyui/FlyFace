...
public class Stats {
    ...
    public static final String ACTION_LAUNCH = "cc.flydev.launcher.action.LAUNCH";
    public static final String PERM_LAUNCH = "cc.flydev.launcher.permission.RECEIVE_LAUNCH_BROADCASTS";

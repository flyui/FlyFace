...
import cc.flydev.launcher.FolderIcon.FolderRingAnimator;
import cc.flydev.launcher.Launcher.CustomContentCallbacks;
import cc.flydev.launcher.LauncherSettings.Favorites;
...
public class Workspace extends SmoothPagedView
    ...
    // Change WORKSPACE_OVERSCROLL_ROTATION = 24f TO 20f 2014-4-5
    // Change FLYING_THRESHOLD_VELOCITY = 500 TO 900 2014-4-5
    // Change ADJACENT_SCREEN_DROP_DURATION = 300 TO 200 2014-4-5
    private static final float WORKSPACE_OVERSCROLL_ROTATION = 20f;
    ...
    private static final int ADJACENT_SCREEN_DROP_DURATION = 200;
    private static final int FLING_THRESHOLD_VELOCITY = 900;
